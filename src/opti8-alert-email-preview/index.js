									...
									<div className="card-body alerts">
										...
										<div className="card-row">
											<div className="card-column">
												...
												<p className="elipse-value"><span className="key">CI:</span> <span className="underline-record-link" onclick={() => {dispatch("RECORD_LINK_CMDB_CI#CLICKED", {value: `/now/sow/record/${record['cmdb_ci.sys_class_name'].value}/${record.cmdb_ci.value}/params/extra-params/subTabIndex%2F1/selected-tab-index/1`})}}>{record.cmdb_ci.display_value}</span></p>
